//<script type="text/javascript">
	...
	function GeneraForm(){
		...
		let cajaTextContra=document.createElement("input");
 
		////Crear el objeto area de texto del Mensaje
		let cajaTextContras=document.createElement("textarea");
		...
		////Asignar atributos al objeto formulario
        	...
        	cajaTextContra.setAttribute('type', "text");//Asignar el atributo type
        	cajaTextContra.setAttribute('placeholder', "Asunto");//Asignar el atributo placeholder
        	cajaTextContra.setAttribute('style', "width:100%;margin: 10px 0px;padding: 5px");//Asignar el atributo style
 
        	////Asignar atributos al objeto area de texto de Mensaje
        	cajaTextContras.setAttribute('placeholder', "Mensaje");//Asignar el atributo placeholder
        	cajaTextContras.setAttribute('style', "width:100%;height:200px;margin: 10px 0px;padding: 5px");//Asignar el atributo style
		...
		boton.setAttribute('type', "button");//Asignar el atributo type	
        	...
        	formulario.appendChild(cajaTextContra);//Agregar el objeto caja de texto Asunto al objeto formulario
        	formulario.appendChild(cajaTextContras);//Agregar el objeto area de texto del Mensaje al objeto formulario
